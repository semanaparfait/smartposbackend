...
export class Update1789160533319 implements MigrationInterface {
    name = 'Update1789160533319'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('SUPERADMIN', 'ADMIN', 'OWNER', 'EMPLOYEE')`);
